...
class mc_stockist_table extends WP_List_Table
{
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'mc_stockist',     //singular name of the listed records
            'plural'    => 'mc_stockists',    //plural name of the listed records
    ...
    function column_default($item, $column_name){
        switch($column_name){ 
            ...
            case 'country':
                ...
                return _t('span', ucwords($state), array('icon-flag-'.$item[$column_name])); 
            break;   
            case 'total_sales':
            case 'sales_average':
                $amount = $item[$column_name];
                if (empty($amount)) $amount = 0.0;
                return 'RM '.apply_filters('mc_curreny',$amount);
            break;               
            //case 'date':
            //case 'tel':
            case 'name':
    ...
    function column_code($item){
        ...
        $uri = sprintf('<a href="?page=%s&user_id=%s">%s</a>','wp_crm_add_new',$item['id'], $item['code']);
    ...
    function column_name($item){
        $uri = '?page=wp_crm_add_new&user_id='.$item['id'];
        return _t('a',$item['name'],array('href'=>$uri));
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'type'          => array('Stockist Type',false),
            //'date'          => array('date',false),
            'total_members' => array('total_members',false),
            'code' => array('code',false),
            'sales_count'   => array('sales_count',false),
            'sales_average' => array('sales_average',false),
